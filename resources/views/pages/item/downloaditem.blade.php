        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-sky-600 flex items-center gap-2">
                ...
                <span
                    ...
                    data-tip="Download Item Information"
                >
                    <svg
        ...
        >
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <div class="relative w-full md:w-80">
                    <input
                        type="text"
                        placeholder="Search your item (max : 5)"
        ...
        >
            ...
            >
                ...
                <p class="text-sm mt-1 text-gray-500">
                    Time to break the silence - Get item from marketplace,
                    <a href="#" class="text-sky-500 hover:underline">here</a>
                    .
                </p>
            </div>
        </div>
