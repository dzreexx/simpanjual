    ...
    <div class="bg-base-100 p-6 h-full font-sans">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-sky-600 flex items-center gap-2">
                ...
                <span
                    ...
                    data-tip="Item Published Information"
                >
                    <svg
        ...
        <div class="mb-6 overflow-x-auto">
            ...
            >
                ...
                <a href="#" class="hover:text-gray-700 px-1">Pending</a>
                <a href="#" class="hover:text-gray-700 px-1">Failed</a>
            </div>
        </div>
        ...
        >
            <div class="flex items-center gap-3">
                <div class="btn-group border border-gray-300 rounded-lg">
                    <button
                        class="btn btn-sm btn-ghost text-sky-500 bg-sky-50 px-2"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                    ...
                    <button class="btn btn-sm btn-ghost text-gray-400 px-2">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <div class="relative w-full md:w-80">
                    <input
                        type="text"
                        placeholder="Search your items here (max : 5)"
        ...
        >
            ...
            >
                <div class="mb-4 text-gray-300">
                    {{-- Placeholder Icon for the 'Ghost' (Winking) --}}
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <p class="text-sm mt-1 text-gray-500">
                    ...
                    <span class="text-sky-600 font-semibold">"Create New"</span>
                    and make your first item published!
                </p>
            </div>
        </div>
