    ...
    <div class="bg-base-100 p-6 h-full font-sans">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-sky-600 flex items-center gap-2">
                ...
                <span
                    ...
                    data-tip="Bundle Stock Information"
                >
                    <svg
        ...
        <div class="mb-6 overflow-x-auto">
            ...
            >
                ...
                <a href="#" class="hover:text-gray-700 px-1">Inactive</a>
            </div>
        </div>
        ...
        {{-- Info Banner --}}
        <div
            class="alert alert-info bg-sky-50 border-sky-200 text-sky-600 mb-6 flex justify-between items-center rounded-lg shadow-sm"
        >
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium">
                    Already have a bundle SKU? Click the Migrate button to use
                    this feature.
                </span>
            </div>
            <button
                class="btn btn-sm btn-ghost text-sky-700 hover:bg-sky-100 font-bold"
            >
                Migrate
            </button>
        </div>
