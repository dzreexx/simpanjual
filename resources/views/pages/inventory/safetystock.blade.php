    ...
    <div class="bg-base-100 p-6 h-full font-sans">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-sky-600 flex items-center gap-2">
                ...
                <span
                    ...
                    data-tip="Safety Stock Information"
                >
                    <svg
        ...
        <div class="mb-6 overflow-x-auto">
            ...
            >
                ...
                <a href="#" class="hover:text-gray-700 px-1">Unset</a>
                <a href="#" class="hover:text-gray-700 px-1">Activity Log</a>
            </div>
        </div>
        ...
        >
            ...
            <button
                class="btn btn-info text-white bg-sky-500 hover:bg-sky-600 border-none normal-case"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
