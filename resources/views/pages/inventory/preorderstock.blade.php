    ...
    <div class="bg-base-100 p-6 h-full font-sans">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-sky-600 flex items-center gap-2">
                ...
                <span
                    ...
                    data-tip="Pre-Order Stock Information"
                >
                    <svg
        ...
        <div class="mb-6 overflow-x-auto">
            ...
            >
                ...
                <a href="#" class="hover:text-gray-700 px-1">
                    Sales Order List
                </a>
            </div>
        </div>
        ...
        {{-- Empty State Content --}}
        <div
            class="border border-base-200 rounded-lg bg-white min-h-[500px] flex flex-col justify-center items-center text-center p-10"
        >
            ...
            <button
                class="btn btn-sm bg-gray-100 text-gray-400 border-none hover:bg-gray-200 normal-case"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
